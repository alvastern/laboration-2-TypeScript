...
I main.ts hämtade jag olika element från DOM och manipulerade dem på ett sätt som skapade webbplatsens funktionalitet. Jag använde forEach för att loopa igenom alla punkter och därefter skapa ett list-element, en klar-knapp och en ta bort-knapp för varje punkt som läggs till av användaren i listan. Sedan används eventlyssnare för att användaren vid klick på knapparna, förflyttar de punkter som markeras som klara till en annan lista, samt tar bort de punkter som tas bort.
